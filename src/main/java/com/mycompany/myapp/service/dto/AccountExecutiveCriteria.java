...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.AccountExecutive} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.AccountExecutiveResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /account-executives?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class AccountExecutiveCriteria implements Serializable, Criteria {
    ...
    public AccountExecutiveCriteria() {
    }

    public AccountExecutiveCriteria(AccountExecutiveCriteria other) {
    ...
    @Override
    public AccountExecutiveCriteria copy() {
        return new AccountExecutiveCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AccountExecutiveCriteria that = (AccountExecutiveCriteria) o;
        return
    ...
    public String toString() {
        return "AccountExecutiveCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
