...
export class RegionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('testElasticSearchApp.region.delete.question'));
...
export default class RegionComponentsPage {
  ...
  async deleteRegion() {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/testElasticSearchApp.region.delete.question/);
